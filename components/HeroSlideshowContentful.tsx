...
// Default slides for when Contentful is not configured
...
const HeroSlideshowContentful = ({ slides = defaultSlides }: HeroSlideshowProps) => {
  ...
  if (slides.length === 0) {
    return (
      <div className="relative h-[480px] md:h-[560px] lg:h-[640px] bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
            Welcome to Longshot Coffee
          </h1>
          <p className="font-cursive text-2xl md:text-3xl text-gray-700">
            Exceptional Coffee, Delivered Fresh
          </p>
        </div>
      </div>
    );
...
export default HeroSlideshowContentful;